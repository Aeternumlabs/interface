...
- **Browser wallet** — MetaMask or any wallet that supports the EIP-1193 provider standard. [See supported wallets](/docs/user-guide/connect-wallet#supported-Wallets).
...
<StepList>
  ...
  <StepItem step={6} title="Watch the keeper bot execute the recovery">
