...
<StepList>
  ...
  <StepItem step={3} title="Approve the connection request">
    Your wallet will prompt you to approve the connection to aeternumvault.xyz. This authorises the app to read your address and request transaction signatures — it does not grant the app any authority to sign or broadcast transactions without your explicit approval. Every transaction requires a separate confirmation in your wallet.
  </StepItem>
