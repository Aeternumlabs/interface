...
| --- | --- | --- | --- |
| MetaMask | ✓ | ✓ | Most widely tested |
| Coinbase Wallet | ✓ | ✓ | |
| Rainbow | — | ✓ | Mobile-first |
| WalletConnect | ✓ | ✓ | Scan QR from any compatible wallet |
...
<StepList>
  ...
  <StepItem step={3} title="Approve the connection request">
    Your wallet will prompt you to approve the connection to `aeternumvault.xyz`. This is a read-only permission — it does not grant the app any spending authority over your funds. Approve it.
  </StepItem>
...
<Callout type="info" title="No Sepolia ETH yet?">
  You need Sepolia test ETH to pay for gas and to fund your vault. Get it free from [Google Cloud Web3](https://cloud.google.com/application/web3/faucet/ethereum/sepolia) or [sepoliafaucet.com](https://sepoliafaucet.com). Each faucet allows one claim per day. Request at least 0.05 Sepolia ETH to cover testing comfortably.
</Callout>
