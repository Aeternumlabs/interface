...
**When to use it:** When you want your ETH back without cancelling your vault configuration. Your vault stays registered and active after a withdrawal — you can deposit again any time. Use send() if you want to withdraw a specific amount. withdrawAll() always withdraws your full balance.
...
**Gas cost:** ~30,000 gas — the cheapest possible vault interaction.
