...
<StepList>
  ...
  <StepItem step={5} title="Watch automatic recovery execute">
    ...
    have crossed their inactivity deadline. Within moments of your timer elapsing, 
    it submits `triggerRecovery()` on-chain, and your Sepolia ETH moves to your backup 
    address automatically, with no action required from you.
