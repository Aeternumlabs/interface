...
description: A trustless, non-custodial inheritance and asset recovery protocol for Ethereum — built for people who want self-custody without the risk of permanent asset loss.
---
...
But self-custody carries a risk that almost no one talks about openly: **if you pass away, become incapacitated, or lose access to your keys permanently, your assets are gone forever.** This isn't hypothetical — and the known cases likely understate it. On the Bitcoin blockchain alone, Chainalysis estimated 2.3 to 3.7 million BTC — roughly 11 to 18% of its 21 million maximum supply — is believed to be permanently lost, based on dormancy analysis of wallets that stopped moving in patterns consistent with lost access or death. No equivalent dormancy-based estimate exists for Ethereum specifically, which tells you how unmeasured this problem still is. On a pseudonymous ledger, a wallet that stops moving could mean the owner passed away, lost a seed phrase, misplaced a hardware device, or simply chose to hold — and the chain alone cannot distinguish between them, which is exactly why the public cases aren't the size of the problem. They're just the fraction that happened to become a story.
