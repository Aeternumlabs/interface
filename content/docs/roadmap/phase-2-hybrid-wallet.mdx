...
*The keeper network shown above also expands at this phase: Gelato comes online as a second, independently-operated keeper alongside the Aeternum Labs bot — see [How Recovery Works in Phase 2](#how-recovery-works-in-phase-2) below for what that means in practice.*
