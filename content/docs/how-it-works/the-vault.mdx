...
<Callout type="tip" title="Use ping() when you're not moving funds">
  If you plan to hold ETH for an extended period without transacting, call `ping()` before your inactivity period elapses. It costs roughly 6400–31,000 gas and resets your countdown completely.
</Callout>
